...
echo ============================================================
echo  Spring Boot 2 example (auto config + hot reload + discovery)
...
rem Install the core SDK and the Boot 2 starter into the local repository (needed once, safe to repeat).
call mvn -q -DskipTests -f "..\..\..\java\pom.xml" -pl waymark-spring-boot2-starter -am install
